...
async function buildGraph(snykGraph, projectName, projectVersion) {
    ...
    for (const key of Object.keys(snykGraph)) {
        ...
        snykGraph[key].parentIds = Array.from(new Set(snykGraph[key].parentIds).values());
        ...
        if (parentIds && parentIds.length > 0) {
            for (let parentId of parentIds) {
                ...
                const isSameDependency = parentId === nodeId;
                const existsConnection = connectionsChain.has(`${parentId}|${nodeId}`) &&
