...
var mod = {
	registerRouting : function(app) {
		...
		app.get('/twilio/testlistsessions', function(req, res) {
			res.status(200).json(sessions);
		});
		app.get('/twilio/version', function(req, res) {
			res.status(200).json({version:'20201108-1'});
		});
	}
}
...
var flows = {
	'entryFlow': {
		'steps' : [
			{'type':'stream','url':'wss://conversationalwf.herokuapp.com/twilio/ws'},
